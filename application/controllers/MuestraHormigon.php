...
class MuestraHormigon extends CI_Controller {
	...
	public function ensayo($id)
	{
		...
		else
		{
				if($this->ensayo_model->edit_ensayo($id))
			 	redirect(base_url()."muestrahormigon/ficha/".$data['ensayo']['id_muestra']."/ensayo/success", 'location');	
		else
			 	redirect(base_url()."muestrahormigon/ficha/".$data['ensayo']['id_muestra']."/ensayo/error", 'location');
		}
	...
	public function ajax_list()
	{
		...
		foreach ($list as $hormigon) {
			...
			$row[] = '<a href="'. base_url()."muestrahormigon/ficha/".$hormigon->id_muestra.'/muestra">Ficha</a>';
			$row[] = '<a href="'. base_url()."muestrahormigon/editar/".$hormigon->id_muestra.'">editar</a>';
			$row[] = '<a onclick="return confirmar()" href="'. base_url()."muestrahormigon/eliminar/".$hormigon->id_muestra.'">Eliminar</a>';
			$data[] = $row;
		}
