...
<?php echo form_open(base_url()."usuario/editar/".$id) ?>	
           	...
           	<div class="form-group">
                  ...
                  <input readonly class="form-control" autocomplete="off" name="login" type="text" value="<?php echo $usuario['login']?>" >
                  <div class="form-control-feedback"> <?php echo form_error('login'); ?> </div>
                 
                </div>
     			<div class="form-group">
                  <label class="control-label">Nombre</label>
                  <input class="form-control" autocomplete="off" name="nombre" type="text" value="<?php echo $usuario['nombre']?>" >
