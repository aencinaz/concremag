  <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> Nuevo aditivo</h1>
          <p>Datos del Nuevo aditivo</p>
        </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
           ...
           <?php echo form_open(base_url()."aditivo/nuevo") ?>	

           
     			<div class="form-group">
                  <label class="control-label">Nombre</label>
                  <input class="form-control" autocomplete="off" name="adi_nombre" type="text" placeholder="Ingrese Nombre">
                 ...
                 <div class="form-group">
                  ...
                  <input class="form-control" autocomplete="off" name="adi_descripcion" type="text" placeholder="Ingrese Descripción">
