  <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> Nuevo prensa</h1>
          <p>Datos del Nuevo Prensa</p>
        </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
           ...
           <?php echo form_open(base_url()."prensa/nuevo") ?>	

           
     			<div class="form-group">
                  <label class="control-label">Nombre</label>
                  <input class="form-control" autocomplete="off" name="pre_nombre" type="text" placeholder="Ingrese Nombre">
