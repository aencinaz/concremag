        ...
        <div class="tab-pane fade <?php if($pestana==="muestra"){echo "show active";}?>" id="muestra" role="tabpanel" aria-labelledby="muestra-tab">
          <div class="card-body">
                                        ...
                                        <div class="row">
                                          <div class="col-sm-4">
                                              ...
                                              <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                  <input name="guia" autocomplete="off" value="<?php echo $muestra['mue_guia']; ?>" class="form-control" type="text"  >
                                                </div>
                                              </div>
                                              <div class="form-group row">
                                              ...
                                              <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                  <input name="asentamiento" autocomplete="off" value="<?php echo $muestra['mue_asentamiento_cono']; ?>" class="form-control" type="text" >
                                                </div>
                                              </div>
                                       ...
                                       <div class="col-sm-4">
                                              ...
                                              <div class="form-group row">
                                                <label for="example-url-input" class="col-sm-6 col-form-label">Aditivos</label>
                                                <div class="col-sm-6">
                                       ...
                                       <div class="form-group row">
                                                <label for="example-url-input" class="col-sm-6 col-form-label">Hormigón Grado</label>
                                                <div class="col-sm-6">
                                       ...
                                       <div class="form-group row">
                                                <label for="example-url-input" class="col-sm-6 col-form-label">Compactación</label>
                                                <div class="col-sm-6">
                                       ...
                                       <div class="form-group row">
                                                <label for="example-url-input" class="col-sm-6 col-form-label">Tipo de Camión</label>
                                                <div class="col-sm-6">
                                       ...
                                       <div class="form-group row">
                                                <label for="example-url-input" class="col-sm-6 col-form-label">Panta </label>
                                                <div class="col-sm-6">
                                       ...
                                       <div class="form-group row">
                                                <label for="example-url-input" class="col-sm-6 col-form-label">Cemento</label>
                                                <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-4">
                                                  ...
                                                  <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                      <input name="num_camion" autocomplete="off" value="<?php echo $muestra['mue_numero_camion']; ?>" class="form-control" type="text" >
                                                    </div>
                                                  </div>
